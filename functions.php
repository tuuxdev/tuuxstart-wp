...
function my_assets()
{
  ...
  /*SCRIPTS*/
  //wp_enqueue_script( 'jquery-two', get_template_directory_uri() . '/js/jquery-3.1.1.min.js', array()); 
...
?>
	<style type="text/css">
		...
		body.login div#login h1 a {
			background: url(<?php bloginfo('template_url'); ?>/img/logo.svg) center center no-repeat;
